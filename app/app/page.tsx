      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <section id="hero" className="min-h-[70vh] flex items-center justify-center">
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center space-y-6">
            ...
            <div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="flex gap-4 flex-wrap justify-center">
        ...
        <section id="about" className="py-16">
          ...
          <div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-slate-300 leading-relaxed max-w-2xl space-y-3">
        ...
        <section id="experience" className="py-16">
          ...
          <div className="space-y-6">
            {[
              ...
              <div key={idx} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="border border-slate-800 rounded-lg p-4">
        ...
        <section id="contact" className="py-16 mb-10">
          ...
          <div initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} className="space-y-1 text-sm text-slate-300">
